...
void task1(void *pvParameters)
{
	...
	while(1)
	{
		...
		Debug("\n\rtask1 apply the countsemaphore.");
		xSemaphoreTake(MutexSemaphore,portMAX_DELAY);
		Debug("\n\rtask1 get the mutexsemaphore");
		vTaskDelay(1500);
		Debug("\n\rtask1 give the mutexsemaphore");
...
void task2(void *pvParameters)
{
	...
	while(1)
	{
		...
		Debug("\n\rtask2 apply the countsemaphore.");
		xSemaphoreTake(MutexSemaphore,portMAX_DELAY);		
		Debug("\n\rtask2 get the countsemaphore");
		vTaskDelay(3000);
		Debug("\n\rtask2 give the mutexsemaphore");
		xSemaphoreGive(MutexSemaphore);
